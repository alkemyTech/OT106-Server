...
const BAD_CREATE_TESTIMONIAL_REQUEST = `Your request body should include 'name', 'content' properties, as well as an image file.`;
const BAD_UPDATE_TESTIMONIAL_REQUEST = `Your request body should include at least one of these properties: 'name', 'content', or an image file.`;
const GOT_TESTIMONIAL = "Successfully fetched testimonial(s).";
const CREATED_TESTIMONIAL = "Successfully created a testimonial.";
const UPDATED_TESTIMONIAL = (id) =>
  `Successfully updated testimonial with id of ${id}`;
const DELETED_TESTIMONIAL = (id) =>
  `Successfully deleted testimonial with id of ${id}`;
